...
const mockMembers: TravelMember[] = [
  {
    ...
    guestName: null,
    role: 'owner',
    user: { id: 'u1', email: 'alice@test.com', name: 'Alice', avatarUrl: null, createdAt: '', updatedAt: '' },
    createdAt: '',
    updatedAt: '',
  },
  {
    ...
    guestName: null,
    role: 'member',
    user: { id: 'u2', email: 'bob@test.com', name: 'Bob', avatarUrl: null, createdAt: '', updatedAt: '' },
    createdAt: '',
    updatedAt: '',
  },
  {
