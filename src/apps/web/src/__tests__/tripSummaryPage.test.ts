...
const mockTravel: TravelDetail = {
  ...
  members: [
    {
      id: 'm1', travelId: 'travel-1', userId: 'u1', guestName: null, role: 'owner',
      user: { id: 'u1', email: 'ricardo@test.com', name: 'Ricardo', avatarUrl: null, createdAt: '', updatedAt: '' },
      createdAt: '', updatedAt: '',
    },
    {
      id: 'm2', travelId: 'travel-1', userId: 'u2', guestName: null, role: 'member',
      user: { id: 'u2', email: 'ana@test.com', name: 'Ana', avatarUrl: null, createdAt: '', updatedAt: '' },
      createdAt: '', updatedAt: '',
    },
    {
      id: 'm3', travelId: 'travel-1', userId: null, guestName: 'Carlos', role: 'member',
      user: null, createdAt: '', updatedAt: '',
    },
    {
      id: 'm4', travelId: 'travel-1', userId: 'u4', guestName: null, role: 'member',
      user: { id: 'u4', email: 'diana@test.com', name: 'Diana', avatarUrl: null, createdAt: '', updatedAt: '' },
      createdAt: '', updatedAt: '',
    },
  ],
  categories: [],
...
describe('TripSummaryPage', () => {
  ...
  describe('hero section', () => {
    ...
    it('renders formatted date range', () => {
      ...
      const end = new Intl.DateTimeFormat('en', { ...opts, year: 'numeric' }).format(new Date(mockTravel.endDate))
  ...
  describe('per-person list', () => {
    ...
    it('shows spending amount per person', () => {
      const spendingMap = new Map(
        mockDashboard.memberSpending.map((ms) => [ms.memberId, ms]),
      )
