...
const mockOptions = {
  ...
  t: (key: string, opts?: Record<string, unknown>) => {
    ...
    if (key === 'summary.biggestDayDesc')
      return `${opts?.date} — ${opts?.amount} spent`
    return key
  },
}
...
const mockDashboard: DashboardData = {
  ...
  categorySpending: [
    { categoryId: 'c1', name: 'Food & Drinks', icon: '🍔', color: '#FF6B35', totalSpent: 980, budgetLimit: 500, status: 'exceeded' },
    { categoryId: 'c2', name: 'Transport', icon: '🚗', color: '#0EA5E9', totalSpent: 420, budgetLimit: 400, status: 'exceeded' },
    { categoryId: 'c3', name: 'Activities', icon: '🎯', color: '#8B5CF6', totalSpent: 350, budgetLimit: 600, status: 'ok' },
  ],
}

const mockExpenses: Expense[] = [
  { id: 'e1', travelId: 't1', categoryId: 'c1', memberId: 'm1', amount: 120, description: 'Dinner', date: '2026-03-16', createdAt: '2026-03-16T19:00:00Z', updatedAt: '2026-03-16T19:00:00Z' },
  { id: 'e2', travelId: 't1', categoryId: 'c1', memberId: 'm1', amount: 80, description: 'Lunch', date: '2026-03-17', createdAt: '2026-03-17T12:00:00Z', updatedAt: '2026-03-17T12:00:00Z' },
  { id: 'e3', travelId: 't1', categoryId: 'c2', memberId: 'm2', amount: 50, description: 'Taxi', date: '2026-03-17', createdAt: '2026-03-17T15:00:00Z', updatedAt: '2026-03-17T15:00:00Z' },
  { id: 'e4', travelId: 't1', categoryId: 'c3', memberId: 'm1', amount: 200, description: 'Sintra day trip', date: '2026-03-18', createdAt: '2026-03-18T09:00:00Z', updatedAt: '2026-03-18T09:00:00Z' },
  { id: 'e5', travelId: 't1', categoryId: 'c1', memberId: 'm3', amount: 350, description: 'Big dinner', date: '2026-03-18', createdAt: '2026-03-18T20:00:00Z', updatedAt: '2026-03-18T20:00:00Z' },
]
...
describe('computeTripInsights', () => {
  ...
  it('handles single member', () => {
    const singleMemberDashboard: DashboardData = {
      ...mockDashboard,
      memberSpending: [
        { memberId: 'm1', displayName: 'Solo Traveler', totalSpent: 1000 },
      ],
    }
  ...
  it('skips Biggest Category when all have zero spending', () => {
    const zeroDashboard: DashboardData = {
      ...mockDashboard,
      categorySpending: [
        { categoryId: 'c1', name: 'Food', icon: '🍔', color: '#FF6B35', totalSpent: 0, budgetLimit: 500, status: 'ok' },
      ],
    }
